 ...
 ${JSON.stringify(location2)}${currentLocation ? "\nwhile being at\n" + JSON.stringify(currentLocation) : ""}`;
  ...
  const RouterViewImpl = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(props, { attrs, slots }) {
      ...
      vue.watch(() => [viewRef.value, matchedRouteRef.value, props.name], ([instance2, to, name], [oldInstance, from, oldName]) => {
        if (to) {
...
function useAsyncData(key, handler, options = {}) {
  ...
  const instance2 = vue_cjs_prod.getCurrentInstance();
  if (instance2 && !instance2._nuxtOnBeforeMountCbs) {
    const cbs = instance2._nuxtOnBeforeMountCbs = [];
    if (instance2 && false) {
...
const components = {
  Anchor: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return Anchor;
  }).then((c) => c.default || c)),
  HotRecommended: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return HotRecommended$1;
  }).then((c) => c.default || c)),
  PageFooter: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return PageFooter;
  }).then((c) => c.default || c)),
  PageFooterPart: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return PageFooterPart;
  }).then((c) => c.default || c)),
  PageHeader: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return PageHeader;
  }).then((c) => c.default || c)),
  Search: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return Search;
  }).then((c) => c.default || c)),
  PartNavLink: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return NavLink;
  }).then((c) => c.default || c)),
  PartNav: vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return index$3;
  }).then((c) => c.default || c))
};
function components_4522e3b2(nuxtApp) {
...
const vueuseHead_800de8f6 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_cd0f250e = defineNuxtPlugin((nuxtApp) => {
  useMeta(metaConfig.globalMeta);
  nuxtApp.vueApp.mixin({
    [metaConfig.mixinKey]() {
      var _a;
      const instance2 = vue_cjs_prod.getCurrentInstance();
      const options = (instance2 == null ? void 0 : instance2.type) || ((_a = instance2 == null ? void 0 : instance2.proxy) == null ? void 0 : _a.$options);
...
const layouts = {
  ...
  test: vue_cjs_prod.defineAsyncComponent({ suspensible: false, loader: () => Promise.resolve().then(function() {
    return test$3;
  }) })
};
...
async function getArticleList() {
  return await useAsyncData("article", () => $fetch(URL.article.list, {
    params: {
      limit: 10
    }
  }));
...
const _sfc_main$r = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const articleRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getArticleList()), __temp = await __temp, __restore(), __temp);
    const articles = articleRes.data.value.data;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "p-articleList" }, _attrs))}><div class="header"><div class="bg"><img src="https://images.uiiiuiii.com/wp-content/uploads/2022/02/bd-fm220226-5-6.jpg" alt=""></div><h1>${serverRenderer.exports.ssrInterpolate(title)}</h1><div class="desc">${serverRenderer.exports.ssrInterpolate(desc)}</div><div class="tags g-wrap"><!--[-->`);
      serverRenderer.exports.ssrRenderList(6, (item) => {
        ...
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "#" }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>#</span>vue <div class="num"${_scopeId}>269\u7BC7\u63A8\u8350</div>`);
            } else {
              return [
                vue_cjs_prod.createVNode("span", null, "#"),
                vue_cjs_prod.createTextVNode("vue "),
                vue_cjs_prod.createVNode("div", { class: "num" }, "269\u7BC7\u63A8\u8350")
              ];
            }
          }),
          _: 2
      ...
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(articles), (article) => {
        ...
        _push(`<a class="name"${serverRenderer.exports.ssrRenderAttr("href", article.link)} target="_blank">${serverRenderer.exports.ssrInterpolate(article.title)}</a></h2><div class="desc">${serverRenderer.exports.ssrInterpolate(article.recommend)}</div><div class="meta"><div class="item">\u6765\u6E90\uFF1A${serverRenderer.exports.ssrInterpolate(article.source)}</div><div class="item">\u63A8\u8350\u65F6\u95F4\uFF1A${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(dayjs)(article._createTime).fromNow())}</div></div></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
async function getClassify() {
  return await useAsyncData("getClassify", () => $fetch(URL.nav.classify, __spreadValues({}, ReqData)));
}
async function getClassifyBySlug(slug) {
  return await useAsyncData(`getClassify-${slug}`, () => $fetch(URL.nav.getClassifyBySlug, {
    method: "POST",
    body: {
      query: {
        "slug": {
...
async function getNav(classify) {
  return await useAsyncData(`getNav-${classify}`, () => $fetch(URL.nav.list, {
    method: "POST",
    body: {
      limit: 20,
      query: {
...
const _sfc_main$q = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    let classifyRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getClassifyBySlug(route.params.id)), __temp = await __temp, __restore(), __temp);
    const classify = classifyRes.data.value.data[0];
    const navRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getNav(classify._id)), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_PartNavLink = vue_cjs_prod.resolveComponent("PartNavLink");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "p-classifySingle" }, _attrs))}><div class="header"><div class="bg"><i style="${serverRenderer.exports.ssrRenderStyle(`background-image: url(${vue_cjs_prod.unref(classify).icon}});`)}"></i></div><h1>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(classify).name)}</h1><p>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(classify).desc)}</p></div><div class="NavBox g-wrap"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(navList), (item) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_PartNavLink, {
          key: item._id,
          title: item.name,
          desc: item.desc,
          url: item.url,
...
_sfc_main$q.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/classify/[id].vue");
...
const _sfc_main$p = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const NavList = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useClassify()), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Anchor = vue_cjs_prod.resolveComponent("Anchor");
      const _component_PartNav = vue_cjs_prod.resolveComponent("PartNav");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "p-home" }, _attrs))}><div class="m-main g-wrap">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Anchor, null, null, _parent));
      _push(`<div class="box"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(NavList), (item) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_PartNav, {
          key: item._id,
          classify: item
        }, null, _parent));
      });
...
async function getWeeklyList() {
  return await useAsyncData("weekly", () => $fetch(URL.weekly.list, {
    params: {
      limit: 10
    }
  }));
}
async function getWeeklySingle(id) {
  return await useAsyncData(`weekly-${id}`, () => $fetch(URL.weekly.list + id));
}
const _sfc_main$o = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const weeklyRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getWeeklySingle(weeklyId)), __temp = await __temp, __restore(), __temp);
    const weekly = weeklyRes.data.value.data;
    const weeklyListRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getWeeklyList()), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "p-weeklySingle" }, _attrs))}><div class="bg"><img${serverRenderer.exports.ssrRenderAttr("src", vue_cjs_prod.unref(weekly).thumb)}${serverRenderer.exports.ssrRenderAttr("alt", vue_cjs_prod.unref(weekly).title)}></div><div class="header g-wrap"><div class="thumb"><img${serverRenderer.exports.ssrRenderAttr("src", vue_cjs_prod.unref(weekly).thumb)}${serverRenderer.exports.ssrRenderAttr("alt", vue_cjs_prod.unref(weekly).title)}></div><div class="box"><h1>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(weekly).title)}</h1><div class="meta"><div class="item"><span>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(weekly).articles.length)}</span>\u7BC7\u6587\u7AE0</div><div class="item"><span>27633</span>\u4EBA\u5B66\u4E60</div></div><div class="desc">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(weekly).desc)}</div><div class="info"><div class="item">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(dayjs)(vue_cjs_prod.unref(weekly)._createTime).fromNow())} \u66F4\u65B0</div></div></div></div><div class="content g-wrap"><div class="posts"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(weekly).articles, (article) => {
        _push(`<div class="m-post"><h2 class="title"><!--[-->`);
        serverRenderer.exports.ssrRenderList(article.tags, (tag) => {
          _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
            to: { path: "/weekly", query: { tag } },
            class: "tag"
          }, {
            default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
      ...
      _push(`<!--]--></div><div class="news"><h3>\u6700\u65B0\u5468\u520A</h3><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(weeklys), (weekly2) => {
        _push(`<div class="item">`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          to: `/article/${weekly2._id}`
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="thumb"${_scopeId}><img${serverRenderer.exports.ssrRenderAttr("src", weekly2.thumb)}${serverRenderer.exports.ssrRenderAttr("alt", weekly2.title)}${_scopeId}></div><h4${_scopeId}>${serverRenderer.exports.ssrInterpolate(weekly2.title)}</h4>`);
            } else {
              return [
                vue_cjs_prod.createVNode("div", { class: "thumb" }, [
                  vue_cjs_prod.createVNode("img", {
                    src: weekly2.thumb,
                    alt: weekly2.title
                  }, null, 8, ["src", "alt"])
                ]),
                vue_cjs_prod.createVNode("h4", null, vue_cjs_prod.toDisplayString(weekly2.title), 1)
              ];
            }
          }),
          _: 2
...
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/weekly/[id].vue");
...
const _sfc_main$n = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const weekRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getWeeklyList()), __temp = await __temp, __restore(), __temp);
    const weeklys = weekRes.data.value.data;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "p-weekly" }, _attrs))}><div class="header"><div class="bg"><img${serverRenderer.exports.ssrRenderAttr("src", vue_cjs_prod.unref(weeklys)[0].thumb)} alt="\u524D\u7AEF\u6280\u672F"></div><h1>${serverRenderer.exports.ssrInterpolate(title)}</h1><p>${serverRenderer.exports.ssrInterpolate(desc)}</p></div><div class="box g-wrap"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(weeklys), (weekly) => {
        _push(`<div class="wrap"><div class="m-weeklyItem"><h2>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          to: `/weekly/${weekly._id}`
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${serverRenderer.exports.ssrInterpolate(weekly.title)}`);
            } else {
              return [
                vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString(weekly.title), 1)
              ];
            }
          }),
          _: 2
        }, _parent));
        _push(`</h2><ul class="list"><!--[-->`);
        serverRenderer.exports.ssrRenderList(weekly.articles, (article) => {
          _push(`<li><a${serverRenderer.exports.ssrRenderAttr("href", article.link)} target="_blank">${serverRenderer.exports.ssrInterpolate(article.title)}</a></li>`);
        });
        _push(`<!--]--></ul><div class="thumb">`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          to: `/weekly/${weekly._id}`
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", weekly.thumb)}${serverRenderer.exports.ssrRenderAttr("alt", weekly.title)}${_scopeId}>`);
            } else {
              return [
                vue_cjs_prod.createVNode("img", {
                  src: weekly.thumb,
        ...
        _push(`</div><div class="footer"><span>\u6587\u7AE0\u6570\u91CF\uFF1A${serverRenderer.exports.ssrInterpolate(weekly.articles.length)} \u7BC7</span><span>\u53D1\u5E03\u65F6\u95F4\uFF1A${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(dayjs)(weekly._createTime).fromNow())}</span>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          class: "more",
          to: `/weekly/${weekly._id}`
        }, {
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`\u67E5\u770B\u8BE6\u7EC6 \u{1F449}\u{1F3FB}`);
            } else {
              return [
                vue_cjs_prod.createTextVNode("\u67E5\u770B\u8BE6\u7EC6 \u{1F449}\u{1F3FB}")
              ];
            }
          }),
          _: 2
...
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/weekly/index.vue");
...
const routes = [
  {
    name: "article",
    path: "/article",
    file: "/Users/zuley/zk-work/vnav/pages/article/index.vue",
    children: [],
    meta: meta$6,
  ...
  },
  {
    name: "classify-id",
    path: "/classify/:id",
    file: "/Users/zuley/zk-work/vnav/pages/classify/[id].vue",
    children: [],
    meta: meta$5,
    component: () => Promise.resolve().then(function() {
      return _id_$1;
  ...
  },
  {
    name: "empty",
    path: "/empty",
    file: "/Users/zuley/zk-work/vnav/pages/empty.vue",
    children: [],
    meta: meta$4,
    component: () => Promise.resolve().then(function() {
      return empty$1;
  ...
  },
  {
    name: "index",
    path: "/",
    file: "/Users/zuley/zk-work/vnav/pages/index.vue",
    children: [],
    meta: meta$3,
    component: () => Promise.resolve().then(function() {
      return index$1;
  ...
  },
  {
    name: "test",
    path: "/test",
    file: "/Users/zuley/zk-work/vnav/pages/test.vue",
    children: [],
    meta: meta$2,
    component: () => Promise.resolve().then(function() {
      return test$1;
  ...
  },
  {
    name: "weekly-id",
    path: "/weekly/:id",
    file: "/Users/zuley/zk-work/vnav/pages/weekly/[id].vue",
    children: [],
    meta: meta$1,
    component: () => Promise.resolve().then(function() {
      return _id_;
  ...
  },
  {
    name: "weekly",
    path: "/weekly",
    file: "/Users/zuley/zk-work/vnav/pages/weekly/index.vue",
    children: [],
    meta,
    component: () => Promise.resolve().then(function() {
      return index;
...
const router_30ff24c6 = defineNuxtPlugin((nuxtApp) => {
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-4858155c"]]);
const _sfc_main$l = {
  __ssrInlineRender: true,
  props: {
    appName: {
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-9a8444be"]]);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$5]]);
let entry;
...
const _sfc_main$g = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const NavList = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useClassify()), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "m-anchor" }, _attrs))}><ul><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(NavList), (item) => {
        _push(`<li>${serverRenderer.exports.ssrInterpolate(item.name)}</li>`);
      });
      _push(`<!--]--></ul></div>`);
    };
  }
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "m-hotRecommended" }, _attrs))}><div class="g-wrap"><ul class="bar-left"><li>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "#" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`\u4F18\u79C0\u8BBE\u8BA1`);
        ...
        return [
          vue_cjs_prod.createTextVNode("\u4F18\u79C0\u8BBE\u8BA1")
        ];
      }
    }),
    _: 1
  ...
  _push(`</li></ul><div class="bar-right"><div class="title">\u7CBE\u9009\u63A8\u8350</div><ul><li>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "#" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`\u4F18\u79C0\u8BBE\u8BA1`);
...
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HotRecommended.vue");
  return _sfc_setup$f ? _sfc_setup$f(props, ctx) : void 0;
};
const HotRecommended = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$4]]);
const HotRecommended$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": HotRecommended
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$e = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "m-footer" }, _attrs))}><p>\u4E0D\u52E4\u52C9\u7684\u4EBA\u751F\u4FBF\u662F\u7F6A\u8FC7\uFF0C\u65E0\u6280\u827A\u7684\u52E4\u52B3\u4FBF\u662F\u7C97\u91CE\u3002</p><div class="info">Copyright @THUNLP 2022</div></div>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$3]]);
const PageFooter = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
const _sfc_main$d = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "part" }, _attrs))}><h3 class="title">${serverRenderer.exports.ssrInterpolate(__props.title)}</h3><ul><!--[-->`);
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/PageFooterPart.vue");
  return _sfc_setup$d ? _sfc_setup$d(props, ctx) : void 0;
};
const PageFooterPart = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$d
}, Symbol.toStringTag, { value: "Module" }));
const globalReqData = {
...
async function getMenus() {
  return await useAsyncData("global-menu", () => $fetch(URL.global.menu, globalReqData));
}
async function getOptions() {
  return await useAsyncData("global-options", () => $fetch(URL.global.options, globalReqData));
}
const _sfc_main$c = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const menuRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getMenus()), __temp = await __temp, __restore(), __temp);
    const menuList = menuRes.data.value.data;
    const opt = useOptions();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = vue_cjs_prod.resolveComponent("NuxtLink");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "m-header" }, _attrs))}><div class="logo">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="icon"${_scopeId}><img${serverRenderer.exports.ssrRenderAttr("src", vue_cjs_prod.unref(opt).get("site-logo"))}${serverRenderer.exports.ssrRenderAttr("alt", vue_cjs_prod.unref(opt).get("site-name"))}${_scopeId}></div><h1${_scopeId}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(opt).get("site-name"))}</h1>`);
          } else {
            return [
              vue_cjs_prod.createVNode("div", { class: "icon" }, [
                vue_cjs_prod.createVNode("img", {
                  src: vue_cjs_prod.unref(opt).get("site-logo"),
                  alt: vue_cjs_prod.unref(opt).get("site-name")
                }, null, 8, ["src", "alt"])
              ]),
              vue_cjs_prod.createVNode("h1", null, vue_cjs_prod.toDisplayString(vue_cjs_prod.unref(opt).get("site-name")), 1)
            ];
          }
        }),
        _: 1
      ...
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(menuList), (item) => {
        _push(`<li>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          to: item.url
        }, {
...
const PageHeader = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$c
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$b = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    const activeIndex = vue_cjs_prod.ref(0);
    const actTab = vue_cjs_prod.computed(() => {
      return tabList[activeIndex.value];
    });
    const keywords = vue_cjs_prod.ref("");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "m-search" }, _attrs))}><ul class="tab"><!--[-->`);
      serverRenderer.exports.ssrRenderList(tabList, (item, index2) => {
        _push(`<li class="${serverRenderer.exports.ssrRenderClass({ active: activeIndex.value === index2 })}">${serverRenderer.exports.ssrInterpolate(item.title)}</li>`);
      });
      _push(`<!--]--></ul><div class="box"><input type="text"${serverRenderer.exports.ssrRenderAttr("placeholder", vue_cjs_prod.unref(actTab).placeholder)}${serverRenderer.exports.ssrRenderAttr("value", keywords.value)}><div class="btn">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(actTab).title)}\u641C\u7D22</div></div></div>`);
    };
  }
});
...
const _sfc_main$a = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "m-navlink" }, _attrs))}><a${serverRenderer.exports.ssrRenderAttr("href", __props.url)} target="_blank"><div class="icon"><img${serverRenderer.exports.ssrRenderAttr("src", __props.icon)}${serverRenderer.exports.ssrRenderAttr("alt", __props.title)}></div><div class="box"><h3>${serverRenderer.exports.ssrInterpolate(__props.title)}</h3><div class="desc">${serverRenderer.exports.ssrInterpolate(__props.desc)}</div></div></a></div>`);
    };
  }
});
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/PartNav/NavLink.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const NavLink = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$a
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main$9 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const Props = __props;
    const navRes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getNav(Props.classify._id)), __temp = await __temp, __restore(), __temp);
    const navList = navRes.data.value.data;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
      const _component_PartNavLink = _sfc_main$a;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        class: "m-partNav",
        id: __props.classify.slug
      }, _attrs))}><div class="head"><h2>${serverRenderer.exports.ssrInterpolate(__props.classify.name)}</h2><div class="tips">${serverRenderer.exports.ssrInterpolate(__props.classify.desc)}</div>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
        class: "more",
        to: `/classify/${__props.classify.slug}`
      }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`\u66F4\u591A`);
            ...
            return [
              vue_cjs_prod.createTextVNode("\u66F4\u591A")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><div class="body"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(navList), (item) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_PartNavLink, {
          key: item._id,
          title: item.name,
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/PartNav/index.vue");
...
const _sfc_main$8 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const opt = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useInitOptions()), __temp = await __temp, __restore(), __temp);
    useState("options", () => opt);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_PageHeader = _sfc_main$c;
      const _component_PageFooter = __nuxt_component_1;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "l-default" }, _attrs))}>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_PageHeader, null, null, _parent));
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "l-default" }, _attrs))}> 233 `);
  serverRenderer.exports.ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</div>`);
}
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/test.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const test$2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$2]]);
const test$3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": test$2
}, Symbol.toStringTag, { value: "Module" }));
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}> \u6B63\u5728\u5F00\u53D1\u4E2D </div>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/empty.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const empty = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1]]);
...
const _sfc_main$3 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const NavList = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useClassify()), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Anchor = _sfc_main$g;
      const _component_PartNav = _sfc_main$9;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "p-home" }, _attrs))}><div class="m-main g-wrap">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Anchor, null, null, _parent));
      _push(`<div class="box"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(NavList), (item) => {
...
const test = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]);
